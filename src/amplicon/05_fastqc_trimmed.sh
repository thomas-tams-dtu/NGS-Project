...
ls ../../data/amplicon/trimmed_reads/*_1.fastq.gz | parallel fastqc -q -o $output_dir {} > $log_path
ls ../../data/amplicon/trimmed_reads/*_2.fastq.gz | parallel fastqc -q -o $output_dir {} >> $log_path
